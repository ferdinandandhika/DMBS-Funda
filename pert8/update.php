<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_query = "UPDATE mahasiswa_50421513 SET nama='$nama', npm='$npm', materi_kursus='$materi_kursus' WHERE id=$id";
        ...
        $id = $_GET['id'];
        $fetch_data_query = "SELECT * FROM mahasiswa_50421513 WHERE id=$id";
